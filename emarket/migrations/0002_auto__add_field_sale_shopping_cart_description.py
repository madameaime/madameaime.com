...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.shopping_cart_description'
        db.add_column('emarket_sale', 'shopping_cart_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.shopping_cart_description'
        db.delete_column('emarket_sale', 'shopping_cart_description')
    ...
    models = {
        ...
        'emarket.sale': {
            ...
            'shopping_cart_description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
