...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveryTracking'
        db.create_table(u'emarket_deliverytracking', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emarket.OrderSale'], unique=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('transport_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('tracking_number', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('sent_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'emarket', ['DeliveryTracking'])


    def backwards(self, orm):
        # Deleting model 'DeliveryTracking'
        db.delete_table(u'emarket_deliverytracking')
    ...
    models = {
        ...
        u'emarket.deliverytracking': {
            'Meta': {'object_name': 'DeliveryTracking'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_sale': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emarket.OrderSale']", 'unique': 'True'}),
            'sent_date': ('django.db.models.fields.DateField', [], {}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'tracking_number': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'transport_type': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        u'emarket.order': {
            ...
            'promo_code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emarket.PromoCode']", 'null': 'True', 'blank': 'True'}),
        ...
        u'emarket.promocode': {
            ...
            'discount': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'expire': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sale': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emarket.Sale']", 'null': 'True', 'blank': 'True'})
        },
        u'emarket.sale': {
            ...
            'transport_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emarket.TransportType']", 'null': 'True', 'blank': 'True'})
        },
        u'emarket.transporttype': {
            'Meta': {'object_name': 'TransportType'},
            'ads_field': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'as_string': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'mmm.user': {
