...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Order', fields ['exposed_id']
        db.create_unique(u'emarket_order', ['exposed_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Order', fields ['exposed_id']
        db.delete_unique(u'emarket_order', ['exposed_id'])
    ...
    models = {
        ...
        u'emarket.deliverytracking': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_sale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'delivery_tracking'", 'unique': 'True', 'to': u"orm['emarket.OrderSale']"}),
        ...
        u'emarket.order': {
            ...
            'exposed_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
