...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Be2billTransaction', fields ['order']
        db.delete_unique(u'emarket_be2billtransaction', ['order_id'])

        # Adding field 'Be2billTransaction.date_insert'
        db.add_column(u'emarket_be2billtransaction', 'date_insert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2000, 1, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Be2billTransaction.date_insert'
        db.delete_column(u'emarket_be2billtransaction', 'date_insert')

        # Adding unique constraint on 'Be2billTransaction', fields ['order']
        db.create_unique(u'emarket_be2billtransaction', ['order_id'])
