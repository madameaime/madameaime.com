...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.promo_code'
        db.add_column(u'emarket_order', 'promo_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emarket.PromoCode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.promo_code'
        db.delete_column(u'emarket_order', 'promo_code_id')
