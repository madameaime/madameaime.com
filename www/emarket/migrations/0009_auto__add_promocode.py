...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emarket_promocode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emarket.Sale'], null=True, blank=True)),
            ('expire', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('discount', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal(u'emarket', ['PromoCode'])


    def backwards(self, orm):
        # Deleting model 'PromoCode'
        db.delete_table(u'emarket_promocode')
