...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emarket_transporttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ads_field', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('as_string', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'emarket', ['TransportType'])

        # Adding field 'Sale.transport_type'
        db.add_column(u'emarket_sale', 'transport_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emarket.TransportType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TransportType'
        db.delete_table(u'emarket_transporttype')

        # Deleting field 'Sale.transport_type'
        db.delete_column(u'emarket_sale', 'transport_type_id')
