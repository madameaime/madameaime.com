...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveredProduct'
        db.create_table(u'emarket_deliveredproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emarket.OrderSale'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stockmgmt.Product'])),
        ))
        db.send_create_signal(u'emarket', ['DeliveredProduct'])

        # Deleting field 'OrderSale.delivered'
        db.delete_column(u'emarket_ordersale', 'delivered')


    def backwards(self, orm):
        # Deleting model 'DeliveredProduct'
        db.delete_table(u'emarket_deliveredproduct')

        # Adding field 'OrderSale.delivered'
        db.add_column(u'emarket_ordersale', 'delivered',
